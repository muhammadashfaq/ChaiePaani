...
import com.example.muhammadashfaq.eatit.Model.ResturantHomeModel;
import com.example.muhammadashfaq.eatit.ViewHolder.ResturantHomeHoder;
...
public class Home extends AppCompatActivity
    ...
    FirebaseRecyclerAdapter<ResturantHomeModel, ResturantHomeHoder> recyclerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        category = firebaseDatabase.getReference("Resturants");
    ...
    private void loadMenu() {
           spinKitView.setVisibility(View.VISIBLE);
            ...
            recyclerAdapter = new FirebaseRecyclerAdapter<ResturantHomeModel,ResturantHomeHoder>
                    (ResturantHomeModel.class,R.layout.added_resturant_row_layout, ResturantHomeHoder.class,category.getRef()) {
                @Override
                protected void populateViewHolder(final ResturantHomeHoder viewHolder, final ResturantHomeModel model, final int position) {
                    spinKitView.setVisibility(View.GONE);
                    viewHolder.resturantName.setText(model.getName());
                    Picasso.get().load(model.getImage()).placeholder(R.drawable.placeholder)
                            .into(viewHolder.imgVuResturanctPic);
                    ...
                    viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            //Getting category id
                            Intent menuId = new Intent(Home.this, HomeResturant.class);
                            menuId.putExtra("name",model.getName());
